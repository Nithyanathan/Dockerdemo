...
param (
    ...
    HelpMessage= "Source storage account")]
    [ValidatePattern("^[a-z0-9`]{3,24}$")]
    [String]$srcStorageAccountName="aldvuswdiagsta001",

    [Parameter(Mandatory = $false, 
    HelpMessage= "Source key")]
    [String]$srcStorageAccountKey = "bJLN+DHqExiCTcg9KiYmgzscigruYZZuixk+dOA96Y7+KX1iB/kb2vZK8BlJvsyVc9Fvm0w12S0Ir+1OpwYwBg==",
    
    [Parameter(Mandatory = $false, 
    HelpMessage= "Dest storage account ")]
    [ValidatePattern("^[a-z0-9`]{3,24}$")]
    [String]$DestStorageAccountName = "retension",

    [Parameter(Mandatory = $true, 
    HelpMessage= "Destination Storage account key.")]
    [String]$DestStorageAccountKey = "Ldcr8YCu1dpNNg0gCLmNOwCn53cWbJbx23SuXdOI89MtCOKonG+rOrG5m2n3BTD/mjZbv5IHpXe3NwZtA+BEEg==",

    [Parameter(Mandatory = $false, 
    HelpMessage= "Input the full filePath of the AzCopy.exe, e.g.: C:\Program Files (x86)\Microsoft SDKs\Azure\AzCopy\AzCopy.exe")]
    [String]$AzCopyPath = "D:\a\azcopy.exe",
